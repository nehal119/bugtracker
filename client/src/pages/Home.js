            ...
            <div>
                ...
                <Container className="text-center" style={{marginTop: "10rem"}}>
                    ...
                    <ListGroup style={{marginTop: "12rem", lineHeight: "1.5rem"}}>
                        <ListGroupItem className="mb-5" style={{backgroundColor: "#FFE6C4", padding: "3rem"}}>
                            <ListGroupItemHeading>
                                WHY A TRACKER?
                            </ListGroupItemHeading>
                            <hr className="deep-purple accent-2 mb-2 mt-0 d-inline-block mx-auto" style={{width: "60px"}} />
                            <ListGroupItemText>
                                We all face problems working on a project. Managing the project timeline on one place. Keeping track of what new features to add and what to remove. And most importantly the BUGS. Everyone hates them right? They come without your permission and stay until they messed up everything. Did you ever come across a solution for this?
                                Maybe Yes? But could not get time to develop it.
                        ...
                        <ListGroupItemHeading className="">
                            ...
                            <ListGroupItemText>
                                ...
                                We respect your privacy and we got it covered as well. Hence No Worries at all. Just Sign-Up and make your life bugfree.
                            </ListGroupItemText>
                        </ListGroupItem>
                    </ListGroup>
                </Container>
