...
class BugBody extends Component {
	...
	render() {
		...
		return (
			<Container>
				<ListGroup>
					<ListGroupItem className="font-weight-light primary-background text-center p-2 mt-6">
						<h3>{bugData.name}</h3>
						...
						<p>
							...
							{level === 'Normal' ? (
								...
								<span role="img" aria-label="Crical">
									Critical 🟡🟡🟡
								</span>
							) : (
					...
					<ListGroupItem className="mb-5 font-weight-light primary-background text-center p-2 mt-6">
...
export default connect(mapStateToProps, { getBugData, addPatchingUser })(
	BugBody
);
